...
package com.example.capstoneandroidapp.tracking;
...
import com.example.capstoneandroidapp.tflite.Classifier.Recognition;

/** A tracker that handles non-max suppression and matches existing objects to new detections. */
public class MaskMultiBoxTracker {
  ...
  public MaskMultiBoxTracker(final Context context) {
