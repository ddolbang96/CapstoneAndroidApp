...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textView,
      @NonNull TextView textView3, @NonNull TextView textView5, @NonNull TextView tvId,
      @NonNull TextView tvPass) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tv_pass;
      TextView tvPass = rootView.findViewById(id);
      if (tvPass == null) {
        break missingId;
      }

      return new ActivityMainBinding((ConstraintLayout) rootView, textView, textView3, textView5,
          tvId, tvPass);
    }
